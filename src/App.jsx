...
import { getNodesMap } from "./utils/getNodesMap";
...
//   const setNodesMap = useApp((state) => state.setNodesMap);
//   const initEdges = useApp((state) => state.initEdges);
...
//       // if (isDisplayed) {
//       //   // REVIEW: new edge
//       //   const rect = whiteboardWrapperRef.current.getBoundingClientRect();
//       //   const clickX = e.clientX - rect.left;
//       //   const clickY = e.clientY - rect.top;
//       //   const whiteboardX = (clickX - panOffsetPos.x) / scale;
//       //   const whiteboardY = (clickY - panOffsetPos.y) / scale;
//       //   setNewEdgeTargetCoords({ x: whiteboardX, y: whiteboardY });
//       //   const B = 100;
//       //   // REVIEW
//       // }
...
//   useEffect(() => {
//     const map = getNodesMap(initNodes);

//     // idea: maybe I can set up a debounce for this?
//     setNodesMap(map);
//   }, [initNodes, setNodesMap]);
